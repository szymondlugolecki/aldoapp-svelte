...
<button
	use:melt={$root}
	class="relative h-6 w-11 cursor-default rounded-full transition-colors outline-none focus:ring data-[state=unchecked]:bg-muted/80 data-[state=checked]:bg-success border-transparent"
>
	<span
